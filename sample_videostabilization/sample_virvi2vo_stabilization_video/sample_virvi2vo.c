...
int main(int argc __attribute__((__unused__)), char *argv[] __attribute__((__unused__)))
{
    ...
    stAttr.antishake_attr.frame_height = 2208;
    stAttr.antishake_attr.frame_height_strie = 2208;
    stAttr.antishake_attr.frame_width = 1242;
    stAttr.antishake_attr.frame_width_strie =1242;
    stAttr.antishake_attr.number_of_input_buffers = 4;
    stAttr.antishake_attr.number_of_output_buffers = 7;
    stAttr.antishake_attr.operation_mode = 13;
